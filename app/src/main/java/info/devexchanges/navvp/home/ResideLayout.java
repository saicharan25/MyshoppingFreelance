...
public class ResideLayout extends ViewGroup {
     ...
     */
    public static boolean mPreservedOpenState;
...
//            final int fixedPanelWidthLimit = widthAvailable - mOverhangSize;
    ...
    protected boolean drawChild(@NonNull Canvas canvas, @NonNull View child, long drawingTime) {
        ...
        if (mCanSlide && !lp.slideable && mSlideableView != null) {
            ...
            canvas.scale(1 - mSlideOffset / 3, 1 - mSlideOffset / 10, mSlideableView.getLeft(), getHeight()/2 );
    ...
    boolean smoothSlideTo(float slideOffset) {
        ...
        if (mDragHelper.smoothSlideViewTo(mSlideableView, x, mSlideableView.getTop())) {
            ...
            ViewCompat.postInvalidateOnAnimation(this,100,100,100,100);
            return true;
        }
        return false;
    }
